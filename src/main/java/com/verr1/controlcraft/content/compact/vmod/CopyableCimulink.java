...
public interface CopyableCimulink extends ICopyableBlock {
            ...
            @NotNull Function1<? super Function1<? super BlockEntity, Unit>, Unit> function11)
    {
        ...
        VSchematicCompactCenter.PreCimulinkReadVModCompact(serverLevel, map, compoundTag);
    };
    ...
    default void __onPaste(
        ...
        Function1<CompoundTag, CompoundTag> func = tag -> VSchematicCompactCenter.PreCimulinkReadVModCompact(serverLevel, map, tag);
