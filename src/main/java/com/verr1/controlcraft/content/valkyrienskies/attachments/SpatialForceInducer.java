...
public final class SpatialForceInducer extends ExpirableForceInducer<LogicalSpatial>{
    ...
    @Override
    protected void consume(@NotNull PhysShip physShip, @NotNull Function<Long, @Nullable PhysShip> lookupPhysShip, @NotNull LogicalSpatial context, PhysLevel world) {
