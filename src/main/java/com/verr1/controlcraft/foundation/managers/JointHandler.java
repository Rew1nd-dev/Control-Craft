...
public class JointHandler {
    ...
    public static @Nullable Integer retrieveJointId(ConstraintKey key){
        return cache.containsKey(key) ? cache.get(key).ID() : null;
    }
    ...
    public void physTick(PhysLevel world, double delta){
        ...
        VsiPhysLevel core = (VsiPhysLevel) world;
    ...
    public void removeIfNeeded(VsiPhysLevel world){
    ...
    public void removeInvalid(VsiPhysLevel world){
        cache
            .entrySet()
            .stream()
